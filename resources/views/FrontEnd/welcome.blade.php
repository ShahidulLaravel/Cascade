                ...
                <div class="fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                       <li><a href="#"><i class="fa fa-user-o"></i> <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Log in</a></a></li>
						...
						<li><a href="#"><i class="fa fa-user-o"></i>  <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Register</a></a></li>
                        @endif
                    @endauth
                </div>
            @endif
					...
					<div class="row">
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<p>Electro is a Modern E-Commerce Platform</p>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<span class="copyright">
								Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="#" target="_blank">Shahidul Islam Khan</a>
							</span>
						</div>
					</div>
						<!-- /row -->
