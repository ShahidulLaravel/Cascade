 ...
 <tr>
  ...
  <img src="https://i.postimg.cc/8CQzp17x/kumo-logo-1184.png" alt="" width="100px" />
     </td>
   </tr>
        <tr>
           <td>
             <p style="font-size: 24px; color: #4F4F4F; font-weight:  600; margin-top: 30px;"><b> Password Reset Request </b></p>
             <p style="font-size: 18px; color: #4F4F4F; font-weight: 500; margin-top: 10px;"><b> Token No - {{$token}} </b></p>
...
to reset your password.</p>
             ...
             <a href="{{route('password_reset_form', $token)}}">
...
<tr id="footer">
    <td style="max-width: 100%; height: auto; border-bottom: 6px solid #F5A623; background: #FFF2DD; padding: 2rem 3.5rem 1.3rem 3.5rem; margin-bottom: 30px;">
      <img src="https://i.postimg.cc/8CQzp17x/kumo-logo-1184.png" alt="" width="100px" style="margin: auto; display: block;" />
      <p style="font-size: 12px; color: #4F4F4F; text-align: center; line-height: 1.5; margin: 1rem 0;">Copyrights 2023 Kumo E-Commerce - All Rights Reserved.</p>
      ...
      <section id="footer-bottom" style="width: 100%; border-top: 0.4px solid #F5A623; margin-top: 20px; padding-top: 1rem;">
        <p style="text-align: center; color: #4F4F4F; font-size: 12px; line-height: 1.6"> shahidul.webdev@gmail.com | 01942601419</p>
